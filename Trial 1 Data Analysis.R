...
ReadsDunn2 <- dunn_test(data = communitydata1, Reads ~ Treatment)
RichnessDunn3 <- dunn_test(data = communitydata1, Richness ~ Treatment)
ShannonDunn4 <- dunn_test(data = communitydata1, Shannon ~ Treatment)
